class PresentationsController < ApplicationController
  before_action :set_presentation, only: [:show, :edit, :update, :destroy, :play]
  ...
  # GET /presentations/1/play
  # GET /presentations/1/play.json
  def play
  end
  ...
  private
    ...
    def presentation_params
      params.require(:presentation).permit(:title, :author)
    end
end
