...
class SlidesControllerTest < ActionController::TestCase
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post :create, slide: { belongs_to: @slide.belongs_to, image_url: @slide.image_url, page_number: @slide.page_number, title: @slide.title }
    end
  ...
  test "should update slide" do
    patch :update, id: @slide, slide: { belongs_to: @slide.belongs_to, image_url: @slide.image_url, page_number: @slide.page_number, title: @slide.title }
    assert_redirected_to slide_path(assigns(:slide))
  end
